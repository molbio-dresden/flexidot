...
def usage():
    ...
    * ... settings, which are inactive by default can be switched on by invoking the respective option without any argument 
          (-a, -w, -s, -x, -U)
