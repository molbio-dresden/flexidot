...
**Kathrin M. Seibt, Thomas Schmidt, and Tony Heitkam** (2018) "FlexiDot: Highly customizable, ambiguity-aware dotplots for visual sequence analyses". *Bioinformatics*, advance article online. doi: 10.1093/bioinformatics/bty395  -  [**Read article**](https://doi.org/10.1093/bioinformatics/bty395)  -  **LaTeX preprint** is currently deactivated, will be replaced in short time. 

Meanwhile, if you wish access to the pdf, you can follow the link from our [institutions page](https://tu-dresden.de/mn/biologie/botanik/molbio/forschung/software), as it will grant you the rights to access it directly from Bioinformatics.
